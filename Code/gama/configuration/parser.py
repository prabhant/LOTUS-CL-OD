...
#        breakpoint()
        ...
        if isinstance(key, str):
            ...
            if issubclass(key, sklearn.base.ClusterMixin) or (
            ...
            elif issubclass(key, sklearn.base.TransformerMixin) or (
                hasattr(key, "metadata")
...
#                    )
#                )
#            elif issubclass(key, sklearn.cluster._kmeans._BaseKMeans):
#              	pset["prediction"].append(
#                    Primitive(
#                        input=hyperparameter_types, output="prediction", identifier=key
#                    )
